...
# 노선별 방향별 휴게시설
ans = []
sample = './testrestway.json'
for i in range(1, 4):
    URL = f'http://data.ex.co.kr/openapi/business/conveniServiceArea?key=3591832985&type=json&numOfRows=100&pageNo={i}'
    ...
    #     d["list"][i]['unitCode'] = d['list'][i].pop('serviceAreaCode')
